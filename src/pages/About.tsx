...
const About = () => {
    return (
        <div className='about'>
            ...
            <p className='about_text'>This store is owned by family Forestfield and founded in 2022 in Tampere Finland by Anna and assisted by cats Anduin and Valdemar.
